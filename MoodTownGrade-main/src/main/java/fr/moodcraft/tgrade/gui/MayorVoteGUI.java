...
public class MayorVoteGUI {
    ...
    public static final String TITLE = MoodStyle.MAYOR_VOTE_TITLE;
    ...
    public static final int MAX_TOTAL = 25;
    ...
    public static void open(Player p, String town) {
        ...
        if (meta != null) {
            meta.setDisplayName(MoodStyle.button("Vote des Maires"));
        ...
        inv.setItem(BACK, MoodStyle.backItem("Conseil des Maires"));
        inv.setItem(
                SAVE,
                MoodStyle.item(
